...
1. Copy `skills/together.ai/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in together.ai style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow together.ai DESIGN system exactly".
