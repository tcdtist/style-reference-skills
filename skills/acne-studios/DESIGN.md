...
- **Token:** `--font-helvetica-monospaced-pro`
...
:root {
  ...
  --font-helvetica-monospaced-pro: 'Helvetica Monospaced Pro', Space Mono;
  --spacing-4: 4px;
  --spacing-9: 9px;
  --spacing-10: 10px;
  --spacing-11: 11px;
