...
1. Copy `skills/theverge/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in theverge style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow theverge DESIGN system exactly".
