...
1. Copy `skills/spacex/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in spacex style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow spacex DESIGN system exactly".
