...
1. Copy `skills/cursor/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Cursor style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Cursor DESIGN system exactly".
