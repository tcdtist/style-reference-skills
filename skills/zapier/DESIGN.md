...
1. Copy `skills/zapier/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in zapier style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow zapier DESIGN system exactly".
