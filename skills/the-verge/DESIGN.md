...
refero_style_id: "e8c4206d-9a2a-4c08-9524-6f14a25e792f"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924629854-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924629854-thumb.jpg"
extracted_at: "2026-04-11T16:24:15.509Z"
---
...
- **Token:** `--font-poly-sans-mono`
- **Substitute:** Space Mono
- **Weights:** 400, 500, 600, 700
- **Sizes:** 11px, 12px
- **Line heights:** 1.18, 1.20, 1.30, 2.00
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgb(60, 255, 208) 0px -1px 0px 0px inset | `--shadow-xl` |
| xl-2 | rgb(0, 0, 0) 0px -1px 0px 0px inset | `--shadow-xl-2` |
...
- **Shadow 1:** `rgb(60, 255, 208) 0px -1px 0px 0px inset`
- **Shadow 2:** `rgb(0, 0, 0) 0px -1px 0px 0px inset`
...
:root {
  ...
  --font-poly-sans: 'Poly Sans', Inter;
  --font-manuka: 'Manuka', Playfair Display;
  --font-fk-roman-standard: 'Fk Roman Standard', Libre Baskerville;
  --font-poly-sans-mono: 'Poly Sans Mono', Space Mono;
  --font-ui-sans-serif: 'ui-sans-serif', System Sans-serif;
  --text-caption: 10px;
  --leading-caption: 1.4;
  --text-body: 16px;
  --leading-body: 1.5;
  ...
  --shadow-xl: rgb(60, 255, 208) 0px -1px 0px 0px inset;
  --shadow-xl-2: rgb(0, 0, 0) 0px -1px 0px 0px inset;
}
```
