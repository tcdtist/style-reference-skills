...
- **Line heights:** 1.00, 1.33, 1.40, 1.56, 1.65, 1.70, 3.00
...
- **Token:** `--font-sang-bleu`
- **Substitute:** Playfair Display
- **Weights:** 400, 700, 900
- **Sizes:** 42px, 80px, 120px
- **Line heights:** 1.00, 1.20, 1.65
...
:root {
  ...
  --font-sang-bleu: 'Sang Bleu', Playfair Display;
  --spacing-4: 4px;
  --spacing-5: 5px;
  --spacing-6: 6px;
  --spacing-7: 7px;
