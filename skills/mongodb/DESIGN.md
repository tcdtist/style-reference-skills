...
1. Copy `skills/mongodb/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in MongoDB style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow MongoDB DESIGN system exactly".
