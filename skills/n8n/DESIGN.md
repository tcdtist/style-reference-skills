...
refero_style_id: "8601c8ef-e1ea-4186-adb2-6f9a74caf436"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775945052045-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775945052045-thumb.jpg"
extracted_at: "2026-04-11T22:06:16.927Z"
---
...
| Ember CTA | #fd8925 | `--color-ember-cta` | Primary CTA buttons — orange-to-red gradient (rgb(253,137,37) → rgb(255,12,0)) burns against the dark void; the only warm-chromatic element above the fold, creating immediate focal pull |
| Electric Current | #077ac7 | `--color-electric-current` | Link underline glow, active focus rings, node connection lines in workflow canvas — blue-to-violet gradient (rgb(7,122,199) → rgb(107,33,239)) signals data flow and connectivity |
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(255, 255, 255, 0.2) 0px 1px 1px 0px inset, rgba(8, 8, 8, 0.2) 0px 1px 2px 0px, rgba(8, 8, 8, 0.08) 0px 4px 4px 0px, rgb(7, 122, 199) 0px 7px 0px -12px, rgba(255, 255, 255, 0.12) 0px 6px 12px 0px inset | `--shadow-xl` |
| xl-2 | rgba(0, 0, 0, 0.26) 0px 0px 8px 0px | `--shadow-xl-2` |
| xl-3 | rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset, rgba(255, 142, 93, 0.3) 0px 1px 0px 0px inset | `--shadow-xl-3` |
...
| --- | --- | --- | --- |
| — | Void Base | #0e0918 | Page background, hero, full-bleed sections |
...
- **Shadow 1:** `rgba(255, 255, 255, 0.2) 0px 1px 1px 0px inset, rgba(8, 8, 8, 0.2) 0px 1px 2px 0px, rgba(8, 8, 8, 0.08) 0px 4px 4px 0px, rgb(7, 122, 199) 0px 7px 0px -12px, rgba(255, 255, 255, 0.12) 0px 6px 12px 0px inset`
- **Shadow 2:** `rgba(0, 0, 0, 0.26) 0px 0px 8px 0px`
- **Shadow 3:** `rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset, rgba(255, 142, 93, 0.3) 0px 1px 0px 0px inset`
...
:root {
  ...
  --font-geomanist: 'geomanist', DM Sans, Inter (variable, set to weight 300 for display);
  --font-geomanist-book: 'geomanist-book', DM Sans 500;
  --text-caption: 12px;
  --leading-caption: 1.5;
  --text-body-sm: 14px;
  --leading-body-sm: 1.5;
  ...
  --shadow-xl: rgba(255, 255, 255, 0.2) 0px 1px 1px 0px inset, rgba(8, 8, 8, 0.2) 0px 1px 2px 0px, rgba(8, 8, 8, 0.08) 0px 4px 4px 0px, rgb(7, 122, 199) 0px 7px 0px -12px, rgba(255, 255, 255, 0.12) 0px 6px 12px 0px inset;
  --shadow-xl-2: rgba(0, 0, 0, 0.26) 0px 0px 8px 0px;
  --shadow-xl-3: rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset, rgba(255, 142, 93, 0.3) 0px 1px 0px 0px inset;
