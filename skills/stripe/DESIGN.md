...
1. Copy `skills/stripe/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in stripe style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow stripe DESIGN system exactly".
