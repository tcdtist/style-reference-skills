...
1. Copy `skills/binance/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Binance style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Binance DESIGN system exactly".
