...
1. Copy `skills/mistral.ai/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Mistral AI style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Mistral AI DESIGN system exactly".
