...
refero_style_id: "14e563d8-a35a-4867-b4bf-15d1620ddae7"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924644086-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924644086-thumb.jpg"
extracted_at: "2026-04-11T16:24:28.267Z"
---
...
- **Line heights:** 1.00, 1.20, 1.33, 1.40, 1.54
...
- **Token:** `--font-apple-system-ui-serif`
- **Substitute:** Georgia, Times New Roman, serif
- **Weights:** 400
- **Sizes:** 20px
- **Line heights:** 1.60
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(255, 255, 255, 0.2) 0px 1px 0px 0px inset, rgba(0, 0, 0, 0.1) 0px -1px 0px 0px inset | `--shadow-xl` |
| xl-2 | rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px | `--shadow-xl-2` |
...
:root {
  ...
  --font-system-ui: 'system-ui', Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;
  --font-cahuenga: 'Cahuenga', ui-sans-serif, system-ui, sans-serif;
  --font-spectral: 'Spectral', Georgia, Times New Roman, serif;
  --font-jetbrains-mono: 'Jetbrains Mono', Menlo, Monaco, Consolas, 'Courier New', monospace;
  --font-apple-system-ui-serif: '-apple-system-ui-serif', Georgia, Times New Roman, serif;
  --text-caption: 12px;
  ...
  --shadow-xl: rgba(255, 255, 255, 0.2) 0px 1px 0px 0px inset, rgba(0, 0, 0, 0.1) 0px -1px 0px 0px inset;
  --shadow-xl-2: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;
}
```
