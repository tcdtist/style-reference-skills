...
theme: "light"
industry: "ecommerce"
source_url: "https://mybrentano.ch"
refero_style_id: "d211aaa4-e09b-4ef9-a9bf-f6fa8495de73"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515108907-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515108907-thumb.jpg"
extracted_at: "2026-04-30T02:12:18.639Z"
---
...
- **Token:** `--font-studio-feixen-sans-writer-book`
- **Substitute:** Inter
- **Weights:** 400
- **Sizes:** 12px, 15px, 18px, 25px, 30px, 60px
- **Line heights:** 1.20, 1.67, 2.08, 2.50
...
- **Token:** `--font-studio-feixen-sans-book`
- **Substitute:** Inter
- **Weights:** 400
- **Sizes:** 15px, 30px
- **Line heights:** 1.20
...
### Studio Feixen Sans Writer Book Regular

- **Token:** `--font-studio-feixen-sans-writer-book-regular`
- **Weights:** 400
- **Sizes:** 30px
- **Line heights:** 1.2
...
| --- | --- | --- | --- | --- |
| caption | 12px | 1.67 | 0px | `--text-caption` |
| body | 15px | 1.67 | 0px | `--text-body` |
| subheading | 18px | 1.67 | 0px | `--text-subheading` |
| heading-sm | 25px | 1.2 | 0px | `--text-heading-sm` |
| heading | 30px | 1.2 | 0px | `--text-heading` |
| display | 60px | 1.2 | 0px | `--text-display` |
...
:root {
  ...
  --font-studio-feixen-sans-writer-book: 'Studio Feixen Sans Writer Book', Inter;
  --font-studio-feixen-sans-writer-book: 'Studio Feixen Sans Writer Book', Inter;
  --font-studio-feixen-sans-book: 'Studio Feixen Sans Book', Inter;
