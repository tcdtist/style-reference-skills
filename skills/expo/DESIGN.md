...
1. Copy `skills/expo/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Expo style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Expo DESIGN system exactly".
