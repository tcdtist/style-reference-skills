...
source_url: "https://slite.com"
refero_style_id: "607c2098-bbbb-40bb-b23e-adf2b72c63dd"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934226984-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934226984-thumb.jpg"
extracted_at: "2026-04-11T19:05:55.514Z"
---
...
| Spectrum Gradient | #ef91f7 | `--color-spectrum-gradient` | Hero decorative gradient element — appears on accent strokes in illustration, not UI controls |
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.01) 0px 4px 12px 0px, rgba(0, 0, 0, 0.05) 0px 2px 6px 0px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px | `--shadow-xl` |
...
| --- | --- | --- | --- |
| — | Page Ground | #f9efe4 | Primary page background — the warm cream canvas all content sits on |
...
:root {
  ...
  --font-garnett: 'Garnett', DM Sans or Fraunces for warmth, though neither replicates Garnett's geometric-editorial balance;
  --font-universalsans: 'UniversalSans', Plus Jakarta Sans or Instrument Sans;
  --font-geist-mono: 'Geist Mono', Geist Mono (available via Vercel) or JetBrains Mono;
  --text-caption: 10px;
  --leading-caption: 16;
  --text-body: 14px;
  --leading-body: 22;
  ...
  --shadow-xl: rgba(0, 0, 0, 0.01) 0px 4px 12px 0px, rgba(0, 0, 0, 0.05) 0px 2px 6px 0px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px;
