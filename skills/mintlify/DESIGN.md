...
1. Copy `skills/mintlify/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Mintlify style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Mintlify DESIGN system exactly".
