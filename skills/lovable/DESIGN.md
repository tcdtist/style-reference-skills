...
1. Copy `skills/lovable/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in lovable style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow lovable DESIGN system exactly".
