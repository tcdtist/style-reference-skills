...
- **Token:** `--font-gt-alpina-condensed`
...
- **Token:** `--font-gt-america-condensed`
- **Substitute:** Oswald
- **Weights:** 400
- **Sizes:** 18px, 38px
- **Line heights:** 1.38, 1.56
...
- **Line heights:** 1.33, 1.38, 1.50, 1.56
...
:root {
  ...
  --font-gt-alpina-condensed: 'GT-Alpina-Condensed', Playfair Display;
  --font-gt-america-condensed: 'GT-America-Condensed', Oswald;
  --font-gt-america-standard: 'GT-America-Standard', Inter;
