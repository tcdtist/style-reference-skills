...
theme: "dark"
industry: "devtools"
source_url: "https://jetbrains.com"
refero_style_id: "bc4fb98b-37ec-480a-b7a9-acd197cbebb9"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934495602-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934495602-thumb.jpg"
extracted_at: "2026-04-11T19:10:37.048Z"
---
...
| Nebula Violet | #5a1fd0 | `--color-nebula-violet` | Hero gradient bloom origin |
| Aurora Teal | #08deaa | `--color-aurora-teal` | Section accent headings, icon fills, gradient stop — teal-to-blue gradient used on feature callouts |
| Hero Blue Glow | #0047fd | `--color-hero-blue-glow` | Radial glow behind hero content — the deep blue spotlight effect that dominates the first viewport |
...
- **Token:** `--font-jetbrains-sans`
- **Substitute:** Inter, Plus Jakarta Sans
- **Weights:** 300, 400, 500, 600
- **Sizes:** 13px, 16px, 20px, 29px, 35px, 43px, 72px, 79px
- **Line heights:** 0.90–1.54 (tighter at larger sizes: 0.90 at display, 1.50–1.54 at body)
...
:root {
  ...
  --font-jetbrains-sans: 'JetBrains Sans', Inter, Plus Jakarta Sans;
  --text-caption: 13px;
  --leading-caption: 1.2;
