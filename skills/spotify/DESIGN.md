...
1. Copy `skills/spotify/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in spotify style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow spotify DESIGN system exactly".
