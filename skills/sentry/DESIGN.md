...
1. Copy `skills/sentry/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in sentry style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow sentry DESIGN system exactly".
