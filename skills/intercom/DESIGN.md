...
1. Copy `skills/intercom/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Intercom style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Intercom DESIGN system exactly".
