...
refero_style_id: "86a6814d-2485-4fad-b6fd-56c2d0a23620"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932910523-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932910523-thumb.jpg"
extracted_at: "2026-04-11T18:42:12.475Z"
---
...
- **Token:** `--font-square-sans-display-vf`
- **Substitute:** Inter
- **Weights:** 400, 500
- **Sizes:** 16px, 20px, 24px, 32px, 50px, 62px, 86px
- **Line heights:** 0.97, 1.10, 1.12, 1.19, 1.25, 1.30, 1.33, 1.42, 1.50
...
- **Token:** `--font-square-sans-text-vf`
- **Substitute:** Inter
- **Weights:** 400, 500
- **Sizes:** 12px, 14px, 16px
- **Line heights:** 1.38, 1.43, 1.50, 1.71, 1.75, 2.00, 2.63
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.16) 0px 1px 4px 0px | `--shadow-xl` |
...
- **Shadow 1:** `rgba(0, 0, 0, 0.16) 0px 1px 4px 0px`
...
:root {
  ...
  --font-square-sans-display-vf: 'Square Sans Display VF', Inter;
  --font-square-sans-text-vf: 'Square Sans Text VF', Inter;
  --font-cash-sans: 'Cash Sans', IBM Plex Mono;
  --text-caption: 12px;
  --leading-caption: 2;
  --text-body-sm: 14px;
  ...
  --shadow-xl: rgba(0, 0, 0, 0.16) 0px 1px 4px 0px;
}
```
