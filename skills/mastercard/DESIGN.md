...
1. Copy `skills/mastercard/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in mastercard style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow mastercard DESIGN system exactly".
