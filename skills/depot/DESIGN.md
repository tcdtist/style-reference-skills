...
theme: "dark"
industry: "devtools"
source_url: "https://depot.dev"
refero_style_id: "f4636c5b-1342-48b2-b9b1-a82e2182440e"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923347681-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923347681-thumb.jpg"
extracted_at: "2026-04-11T16:02:55.915Z"
---
...
- **Token:** `--font-red-hat-text-variable`
...
- **Token:** `--font-red-hat-mono-variable`
- **Substitute:** SFMono-Regular, monospace
- **Weights:** 400
- **Sizes:** 14px, 18px
- **Line heights:** 1.43, 1.56
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(255, 255, 255, 0.06) 0px 1px 0px 0px inset | `--shadow-xl` |
...
:root {
  ...
  --font-red-hat-display-variable: 'Red Hat Display Variable', Segoe UI, sans-serif;
  --font-red-hat-text-variable: 'Red Hat Text Variable', Roboto, Arial, sans-serif;
  --font-red-hat-mono-variable: 'Red Hat Mono Variable', SFMono-Regular, monospace;
  --text-caption: 10px;
  --leading-caption: 1.5;
  ...
  --shadow-xl: rgba(255, 255, 255, 0.06) 0px 1px 0px 0px inset;
}
```
