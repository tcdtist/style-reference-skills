...
theme: "light"
industry: "ecommerce"
source_url: "https://www.shupatto.com/en"
refero_style_id: "17824ea8-ac7d-42ca-97e2-9bf92ebea7e1"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508062204-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508062204-thumb.jpg"
extracted_at: "2026-04-30T00:14:53.956Z"
---
...
- **Token:** `--font-gill-sans-nova-book`
- **Weights:** 500
- **Sizes:** 12px, 16px, 18px, 19px, 21px, 22px, 28px
- **Line heights:** 1.00, 1.22, 1.25, 1.29, 1.33
...
- **Token:** `--font-gill-sans-nova-semibold`
- **Weights:** 800
- **Sizes:** 8px, 18px, 21px, 28px
- **Line heights:** 1.00, 1.22, 1.29, 1.33, 2.50
...
- **Token:** `--font-gill-sans-nova-medium`
- **Weights:** 600
- **Sizes:** 10px, 17px
...
:root {
  ...
  --font-token: '游ゴシック体', ui-sans-serif, system-ui, sans-serif;
  --text-body: 16px;
  --leading-body: 1.25;
