...
theme: "light"
industry: "design"
source_url: "https://fontsinuse.com"
refero_style_id: "348c83bc-bed3-4562-841a-26a30ee19a9b"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924013694-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924013694-thumb.jpg"
extracted_at: "2026-04-11T16:13:50.730Z"
---
...
- **Token:** `--font-benton-sans-re`
- **Substitute:** Inter
- **Weights:** 400, 700
- **Sizes:** 9px, 10px, 12px, 14px, 16px
- **Line heights:** 1.10, 1.20, 1.60
...
- **Token:** `--font-relay-cond`
- **Substitute:** Oswald
- **Weights:** 400, 700
- **Sizes:** 18px, 36px
- **Line heights:** 1.00, 1.60
- **Letter spacing:** normal
...
:root {
  ...
  --font-benton-sans-re: 'Benton Sans RE', Inter;
  --font-relay-cond: 'Relay Cond', Oswald;
  --text-caption: 10px;
  --leading-caption: 1.1;
  --text-body: 14px;
  --leading-body: 1.6;
