...
1. Copy `skills/nike/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Nike style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Nike DESIGN system exactly".
