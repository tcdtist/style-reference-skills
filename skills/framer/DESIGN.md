...
refero_style_id: "d417b42f-824d-45ba-a02e-cbef3b8ea0d8"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776081981265-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776081981265-thumb.jpg"
extracted_at: "2026-04-13T12:06:51.325Z"
---
...
- **Token:** `--font-gt-walsheim-framer-medium`
...
- **Token:** `--font-gt-walsheim-medium`
- **Substitute:** Montserrat
- **Weights:** 500
- **Sizes:** 32px, 62px, 85px
- **Line heights:** 0.95, 1.00, 1.13
...
- **Line heights:** 1.00, 1.20, 1.30, 1.70, 2.28
...
- **Line heights:** 0.80, 1.00, 1.07, 1.20, 1.30, 1.40
...
- **Line heights:** 0.83, 1.00, 1.10, 1.15, 1.20, 1.30, 1.40, 1.60
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgb(9, 9, 9) 0px 0px 0px 2px | `--shadow-xl` |
| xl-2 | rgba(255, 255, 255, 0.1) 0px 0.5px 0px 0.5px, rgba(0, 0, 0, 0.25) 0px 10px 30px 0px | `--shadow-xl-2` |
| xl-3 | rgba(0, 0, 0, 0.3) 0px 10px 10px 0px | `--shadow-xl-3` |
| xl-4 | rgba(0, 0, 0, 0.2) 0px 10px 20px 0px, rgba(0, 0, 0, 0.25) 0px 2px 4px 0px | `--shadow-xl-4` |
...
- **Shadow 1:** `rgb(9, 9, 9) 0px 0px 0px 2px`
- **Shadow 2:** `rgba(255, 255, 255, 0.1) 0px 0.5px 0px 0.5px, rgba(0, 0, 0, 0.25) 0px 10px 30px 0px`
- **Shadow 3:** `rgba(0, 0, 0, 0.3) 0px 10px 10px 0px`
- **Shadow 4:** `rgba(0, 0, 0, 0.2) 0px 10px 20px 0px, rgba(0, 0, 0, 0.25) 0px 2px 4px 0px`
...
:root {
  ...
  --font-gt-walsheim-framer-medium: 'GT Walsheim Framer Medium', Montserrat;
  --font-gt-walsheim-medium: 'GT Walsheim Medium', Montserrat;
  --font-mona-sans: 'Mona Sans', Inter;
  --font-inter-variable: 'Inter Variable', Inter;
  --font-inter: 'Inter', Inter;
  --font-open-runde: 'Open Runde', Varela Round;
  --text-body: 14px;
  --leading-body: 1.3;
  --text-body-lg: 18px;
  --leading-body-lg: 1.4;
  ...
  --shadow-xl: rgb(9, 9, 9) 0px 0px 0px 2px;
  --shadow-xl-2: rgba(255, 255, 255, 0.1) 0px 0.5px 0px 0.5px, rgba(0, 0, 0, 0.25) 0px 10px 30px 0px;
  --shadow-xl-3: rgba(0, 0, 0, 0.3) 0px 10px 10px 0px;
  --shadow-xl-4: rgba(0, 0, 0, 0.2) 0px 10px 20px 0px, rgba(0, 0, 0, 0.25) 0px 2px 4px 0px;
}
```
