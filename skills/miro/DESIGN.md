...
1. Copy `skills/miro/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Miro style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Miro DESIGN system exactly".
