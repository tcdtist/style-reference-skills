...
1. Copy `skills/linear.app/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Linear style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Linear DESIGN system exactly".
