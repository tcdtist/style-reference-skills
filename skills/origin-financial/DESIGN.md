...
theme: "dark"
industry: "fintech"
source_url: "https://www.useorigin.com"
refero_style_id: "c60f05ff-2420-4a24-92db-80c4b6a74683"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509071924-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509071924-thumb.jpg"
extracted_at: "2026-04-30T00:31:42.454Z"
---
...
- **Token:** `--font-suisseintltrial`
- **Substitute:** Montserrat, Lato
- **Weights:** 400
- **Sizes:** 11px, 14px, 16px
- **Line heights:** 1.00, 1.50, 1.67, 2.18
...
- **Line heights:** 1.00, 1.41, 1.43, 1.50, 2.00
...
- **Line heights:** 1.35, 1.40, 1.50, 2.00
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.2) 0px 18px 20px 0px | `--shadow-xl` |
...
- **Shadow 1:** `rgba(0, 0, 0, 0.2) 0px 18px 20px 0px`
...
:root {
  ...
  --font-lyondisplay-app: 'Lyondisplay App', Playfair Display, Lora;
  --font-suisseintltrial: 'Suisseintltrial', Montserrat, Lato;
  --font-suisseintl: 'Suisseintl', Inter, Roboto;
  --font-roboto-mono: 'Roboto Mono', Space Mono, Fira Code;
  --text-caption: 11px;
  --leading-caption: 1.5;
  ...
  --shadow-xl: rgba(0, 0, 0, 0.2) 0px 18px 20px 0px;
