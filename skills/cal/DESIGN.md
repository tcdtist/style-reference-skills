...
1. Copy `skills/cal/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Cal.com style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Cal.com DESIGN system exactly".
