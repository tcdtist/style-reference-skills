...
1. Copy `skills/meta/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in Meta style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow Meta DESIGN system exactly".
