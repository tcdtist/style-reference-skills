...
| --- | --- | --- | --- | --- |
| body-sm | 18px | 1.2 | 0px | `--text-body-sm` |
| heading | 100px | 1.2 | 0px | `--text-heading` |
| display | 108px | 1.2 | 0px | `--text-display` |
...
:root {
  ...
  --font-azeret-mono: 'Azeret Mono', IBM Plex Mono;
  --font-ephidona: 'Ephidona', DM Serif Display;
  --text-body-sm: 18px;
  --leading-body-sm: 1.2;
