...
theme: "light"
industry: "ecommerce"
source_url: "https://bloomers.com.br"
refero_style_id: "043f4cfb-9fe1-45bc-b4cb-8108fdb475fe"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519447734-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519447734-thumb.jpg"
extracted_at: "2026-04-30T03:24:33.087Z"
---
...
| --- | --- | --- | --- | --- |
| caption | 13px | 1.7 | 0.819px | `--text-caption` |
| body | 15px | 1.9 | 1.155px | `--text-body` |
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(255, 107, 157, 0.15) 0px 10px 30px 0px | `--shadow-xl` |
| xl-2 | rgba(255, 107, 157, 0.3) 0px 5px 20px 0px | `--shadow-xl-2` |
| xl-3 | rgba(0, 0, 0, 0.2) 0px 5px 15px 0px | `--shadow-xl-3` |
| xl-4 | rgba(0, 0, 0, 0.2) 0px 10px 40px 0px | `--shadow-xl-4` |
...
| --- | --- | --- | --- |
| — | Page Canvas | #ffffff | Dominant background for the entire site, providing a light, airy foundation. |
...
:root {
  ...
  --font-dancing-script: 'Dancing Script', Dancing Script;
  --font-quicksand: 'Quicksand', Quicksand;
  --text-caption: 13px;
  --leading-caption: 1.7;
  --tracking-caption: 0.819px;
  --text-body: 15px;
  --leading-body: 1.9;
  --tracking-body: 1.155px;
  ...
  --radius-badges: 50px;
  --radius-buttons: 50px;
  --shadow-xl: rgba(255, 107, 157, 0.15) 0px 10px 30px 0px;
  --shadow-xl-2: rgba(255, 107, 157, 0.3) 0px 5px 20px 0px;
  --shadow-xl-3: rgba(0, 0, 0, 0.2) 0px 5px 15px 0px;
  --shadow-xl-4: rgba(0, 0, 0, 0.2) 0px 10px 40px 0px;
