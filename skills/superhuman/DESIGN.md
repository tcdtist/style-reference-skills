...
1. Copy `skills/superhuman/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in superhuman style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow superhuman DESIGN system exactly".
