...
refero_style_id: "729ba7a8-35d5-44f3-abc0-1078ff6a3467"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926103683-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926103683-thumb.jpg"
extracted_at: "2026-04-11T16:48:47.203Z"
---
...
- **Line heights:** 1.00, 1.35, 1.40, 1.50, 1.60, 1.75
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(37, 34, 30, 0.04) 0px 1px 0px 0px | `--shadow-xl` |
| xl-2 | rgba(37, 34, 30, 0.07) 0px 14px 19px -9px, rgba(37, 34, 30, 0.18) 0px 10px 48px 0px | `--shadow-xl-2` |
...
:root {
  ...
  --font-caecilia: 'Caecilia', serif;
  --font-shantell-sans: 'Shantell Sans', cursive;
  --spacing-0: 0px;
  --spacing-4: 4px;
  --spacing-6: 6px;
  --spacing-7: 7px;
  ...
  --radius-buttons: 15px;
  --radius-default: 8px;
  --shadow-xl: rgba(37, 34, 30, 0.04) 0px 1px 0px 0px;
  --shadow-xl-2: rgba(37, 34, 30, 0.07) 0px 14px 19px -9px, rgba(37, 34, 30, 0.18) 0px 10px 48px 0px;
}
```
