...
1. Copy `skills/voltagent/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in voltagent style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow voltagent DESIGN system exactly".
