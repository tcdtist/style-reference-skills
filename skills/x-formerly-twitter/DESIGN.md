...
theme: "light"
industry: "media"
source_url: "https://create.video"
refero_style_id: "655340ae-abff-4a90-8545-8feb62411f68"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514009706-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514009706-thumb.jpg"
extracted_at: "2026-04-30T01:53:48.718Z"
---
...
- **Token:** `--font-twitterchirp`
- **Substitute:** Inter
- **Weights:** 400, 500, 700, 800
- **Sizes:** 11px, 13px, 14px, 15px, 20px, 23px
- **Line heights:** 0.80, 1.09, 1.14, 1.20, 1.22, 1.23, 1.33
...
| --- | --- | --- | --- | --- |
| caption | 11px | 1.23 | 0px | `--text-caption` |
| body-lg | 15px | 1.2 | 0px | `--text-body-lg` |
| heading | 20px | 1.09 | 0px | `--text-heading` |
| display | 23px | 0.8 | 0px | `--text-display` |
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.03) 0px 0px 2px 0px inset | `--shadow-xl` |
| xl-2 | rgba(101, 119, 134, 0.2) 0px 0px 8px 0px, rgba(101, 119, 134, 0.25) 0px 1px 3px 1px | `--shadow-xl-2` |
...
:root {
  ...
  --font-twitterchirp: 'TwitterChirp', Inter;
  --text-caption: 11px;
  ...
  --shadow-xl: rgba(0, 0, 0, 0.03) 0px 0px 2px 0px inset;
  --shadow-xl-2: rgba(101, 119, 134, 0.2) 0px 0px 8px 0px, rgba(101, 119, 134, 0.25) 0px 1px 3px 1px;
