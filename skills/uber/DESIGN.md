...
1. Copy `skills/uber/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in uber style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow uber DESIGN system exactly".
