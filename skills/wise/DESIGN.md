...
1. Copy `skills/wise/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in wise style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow wise DESIGN system exactly".
