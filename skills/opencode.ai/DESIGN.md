...
1. Copy `skills/opencode.ai/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in OpenCode style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow OpenCode DESIGN system exactly".
