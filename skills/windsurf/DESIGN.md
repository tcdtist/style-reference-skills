...
refero_style_id: "cfab7b43-ed24-41e9-9272-c858700b865b"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509201486-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509201486-thumb.jpg"
extracted_at: "2026-04-30T00:33:57.338Z"
---
...
- **Line heights:** 1.00, 1.30, 1.33, 1.50, 1.56, 1.71, 2.40
...
- **Line heights:** 1.20, 1.43, 1.56, 1.71
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.2) 0px 10px 15px -3px, rgba(0, 0, 0, 0.2) 0px 4px 6px -4px | `--shadow-xl` |
| xl-2 | rgba(52, 211, 153, 0.5) 0px 1px 2px 0px | `--shadow-xl-2` |
| xl-3 | rgba(0, 0, 0, 0.2) 0px 4px 6px -1px, rgba(0, 0, 0, 0.2) 0px 2px 4px -2px | `--shadow-xl-3` |
| xl-4 | rgba(251, 191, 36, 0.5) 0px 1px 2px 0px | `--shadow-xl-4` |
| xl-5 | rgba(0, 0, 0, 0.22) 0px 4px 16px 0px, rgba(0, 0, 0, 0.14) 0px 1px 3px 0px | `--shadow-xl-5` |
| xl-6 | rgb(251, 156, 229) 0px 0px 0px 1px inset | `--shadow-xl-6` |
...
- **Shadow 1:** `rgba(0, 0, 0, 0.2) 0px 10px 15px -3px, rgba(0, 0, 0, 0.2) 0px 4px 6px -4px`
- **Shadow 2:** `rgba(52, 211, 153, 0.5) 0px 1px 2px 0px`
- **Shadow 3:** `rgba(0, 0, 0, 0.2) 0px 4px 6px -1px, rgba(0, 0, 0, 0.2) 0px 2px 4px -2px`
- **Shadow 4:** `rgba(251, 191, 36, 0.5) 0px 1px 2px 0px`
- **Shadow 5:** `rgba(0, 0, 0, 0.22) 0px 4px 16px 0px, rgba(0, 0, 0, 0.14) 0px 1px 3px 0px`
- **Shadow 6:** `rgb(251, 156, 229) 0px 0px 0px 1px inset`
...
:root {
  ...
  --font-tomatogrotesk: 'tomatoGrotesk', system-ui;
  ...
  --shadow-xl: rgba(0, 0, 0, 0.2) 0px 10px 15px -3px, rgba(0, 0, 0, 0.2) 0px 4px 6px -4px;
  --shadow-xl-2: rgba(52, 211, 153, 0.5) 0px 1px 2px 0px;
  --shadow-xl-3: rgba(0, 0, 0, 0.2) 0px 4px 6px -1px, rgba(0, 0, 0, 0.2) 0px 2px 4px -2px;
  --shadow-xl-4: rgba(251, 191, 36, 0.5) 0px 1px 2px 0px;
  --shadow-xl-5: rgba(0, 0, 0, 0.22) 0px 4px 16px 0px, rgba(0, 0, 0, 0.14) 0px 1px 3px 0px;
  --shadow-xl-6: rgb(251, 156, 229) 0px 0px 0px 1px inset;
}
```
