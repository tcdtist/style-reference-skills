...
- **Token:** `--font-vivey-22-positive`
- **Substitute:** Segoe UI
- **Weights:** 400, 700
- **Sizes:** 10px, 12px, 13px, 14px, 15px, 16px, 18px
- **Line heights:** 1.00, 1.25, 1.30, 1.33, 1.43, 1.50, 1.56
...
- **Token:** `--font-fha-condensed-french-nc`
- **Substitute:** Oswald
- **Weights:** 400
- **Sizes:** 24px, 30px, 32px, 38px, 44px, 48px, 52px, 72px
- **Line heights:** 1.00, 1.10, 1.15, 1.20, 1.33
- **Letter spacing:** normal
...
### Product Cards — Greatest Sips

Captured as a source example component. Use the structure and token choices as a reference for implementation.

### Product Feature Cards — Greatest Sips
...
:root {
  ...
  --font-vivey-22-positive: 'Vivey 22 Positive', Segoe UI;
  --font-fha-condensed-french-nc: 'FHA Condensed French NC', Oswald;
  --spacing-4: 4px;
  --spacing-6: 6px;
  --spacing-8: 8px;
  --spacing-10: 10px;
