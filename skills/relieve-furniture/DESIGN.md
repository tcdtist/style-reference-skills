...
theme: "light"
industry: "other"
source_url: "https://relievefurniture.com"
refero_style_id: "4e7daadc-3dc4-4211-bf25-626ea7b216e6"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520825427-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520825427-thumb.jpg"
extracted_at: "2026-04-30T03:47:27.644Z"
---
...
- **Line heights:** 1.00, 1.15, 1.20, 1.40, 1.50, 1.60, 1.70, 2.00
...
| Name | Value | Token |
| --- | --- | --- |
| xl | rgba(0, 0, 0, 0.25) 0px 0px 15px 0px | `--shadow-xl` |
...
:root {
  ...
  --font-planar: 'Planar', system-ui, sans-serif;
  --text-caption: 10px;
  --leading-caption: 1.7;
  --text-body: 14px;
  --leading-body: 1.6;
  ...
  --radius-images: 8px;
  --radius-buttons: 8px;
  --shadow-xl: rgba(0, 0, 0, 0.25) 0px 0px 15px 0px;
