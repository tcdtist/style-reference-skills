...
1. Copy `skills/vercel/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in vercel style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow vercel DESIGN system exactly".
