...
1. Copy `skills/sanity/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in sanity style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow sanity DESIGN system exactly".
