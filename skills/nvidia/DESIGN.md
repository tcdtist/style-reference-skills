...
1. Copy `skills/nvidia/DESIGN.md` into your target project context.
2. Ask the agent: "Build [screen type] in NVIDIA style using the DESIGN tokens and component patterns."
...
- Mention the style anchor directly: "Follow NVIDIA DESIGN system exactly".
