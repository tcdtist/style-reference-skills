...
theme: "mixed"
industry: "saas"
source_url: "https://tella.tv"
refero_style_id: "41547c7a-3bbe-49f0-95d6-9701c9df9a5e"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775935399351-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775935399351-thumb.jpg"
extracted_at: "2026-04-11T19:25:42.180Z"
---
...
| Deep Nebula | #251544 | `--color-deep-nebula` | Hero section footer tone and gradient terminus. Paired with Signal Violet for the dark-to-darker hero gradient that creates depth within the purple field. |
...
| Hero Gradient | #5e51f8 | `--color-hero-gradient` | Full-bleed hero background — Signal Violet to Deep Nebula vertical gradient with radial glow at top center. |

## Tokens — Typography

### NaN Jaune Midi Bold

- **Token:** `--font-nan-jaune-midi-bold`
...
| xl-2 | rgba(0, 0, 0, 0.05) 0px -4px 6px 0px, rgba(0, 0, 0, 0.1) 0px -10px 15px 0px | `--shadow-xl-2` |
| xl-3 | rgba(238, 217, 253, 0.25) 0px 16px 64px 4px, rgba(0, 0, 0, 0.1) 0px 8px 32px 0px | `--shadow-xl-3` |
| xl-4 | rgba(0, 0, 0, 0.16) 0px 2px 4px 0px, rgba(0, 0, 0, 0.16) 0px 4px 8px 0px, rgba(255, 255, 255, 0.25) 0px 1px 1px 0px inset | `--shadow-xl-4` |
| xl-5 | rgba(0, 0, 0, 0.15) 0px 8px 32px 0px | `--shadow-xl-5` |
...
| --- | --- | --- | --- |
| — | Page Background | #f8fafc | Default page surface for feature/content sections |
...
:root {
  ...
  --font-nan-jaune-midi-bold: 'NaN Jaune Midi Bold', Cabinet Grotesk ExtraBold or Clash Display Bold;
  --font-inter: 'Inter', Inter (freely available via Google Fonts);
  --font-sans-serif: 'sans-serif', System sans-serif;
  --text-caption: 12px;
  --leading-caption: 18;
  --text-body-sm: 14px;
  --leading-body-sm: 22;
  ...
  --shadow-xl-2: rgba(0, 0, 0, 0.05) 0px -4px 6px 0px, rgba(0, 0, 0, 0.1) 0px -10px 15px 0px;
  --shadow-xl-3: rgba(238, 217, 253, 0.25) 0px 16px 64px 4px, rgba(0, 0, 0, 0.1) 0px 8px 32px 0px;
  --shadow-xl-4: rgba(0, 0, 0, 0.16) 0px 2px 4px 0px, rgba(0, 0, 0, 0.16) 0px 4px 8px 0px, rgba(255, 255, 255, 0.25) 0px 1px 1px 0px inset;
  --shadow-xl-5: rgba(0, 0, 0, 0.15) 0px 8px 32px 0px;
