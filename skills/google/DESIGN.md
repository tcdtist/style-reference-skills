...
theme: "dark"
industry: "other"
source_url: "https://stojo.co"
refero_style_id: "ec103780-ac86-4bb0-8c21-f887d732e8b4"
screenshot_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521389280-screenshot.jpg"
thumbnail_url: "https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521389280-thumb.jpg"
extracted_at: "2026-04-30T03:57:11.606Z"
---
...
| Charcoal Surface | #303134 | `--color-charcoal-surface` | Primary UI element backgrounds like search bars and default buttons — a slightly lighter surface against the canvas |
...
| Azure Glow | #99c3ff | `--color-azure-glow` | Interactive link text, outlined button borders, and active states—a soft, luminous blue to signify interactivity |
...
- **Token:** `--font-google-sans`
- **Substitute:** Product Sans
- **Weights:** 400, 500
- **Sizes:** 14px, 16px
- **Line heights:** 1.20, 1.38, 1.43
...
| --- | --- | --- | --- |
| — | Twilight Canvas | #16171a | Base page background |
...
:root {
  ...
  --font-google-sans: 'Google Sans', Product Sans;
  --font-google-sans-text: 'Google Sans Text', Roboto;
  ...
  --surface-twilight-canvas: #16171a;
  --surface-charcoal-surface: #303134;
  --surface-stone-accent: #4d5156;
}
```
